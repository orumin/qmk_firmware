...
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_UP, KC_DOT,  KC_UP, KC_ENT , \
      KC_ESC,  ADJUST,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,                    KC_SPC,  KC_LEFT,   KC_DOWN, KC_RGHT, KC_DOWN,   KC_RGHT \
      ),
