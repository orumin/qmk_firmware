...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_QWERTY] = LAYOUT( \
        ...
        KC_KANJI,  KC_Q,     KC_W,    KC_E,    KC_R,    KC_T,                                KC_Y,       KC_U,    KC_I,    KC_O,    KC_P,    KC_KANJI, \
        KC_TAB,    KC_A,     KC_S,    KC_D,    KC_F,    KC_G,                                KC_H,       KC_J,    KC_K,    KC_L,    KC_SCLN, KC_TAB, \
        KC_LSFT,   KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,       KC_LBRC,        KC_RBRC, KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH , \
        KC_LCTL,   RGB_MOD,  KC_LALT, KC_LGUI, KC_GUAP, MO(_LOWER), KC_SPC,         KC_ENT, MO(_RAISE),  KC_GUAP, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    /* Lower
    * ,-----------------------------------------.             ,-----------------------------------------.
    * |   ~  |   !  |   @  |   #  |   $  |   %  |             |   ^  |   &  |   *  |   (  |   )  |      |
